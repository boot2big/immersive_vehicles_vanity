...
def main():
    ...
    parser.add_argument("directory_path", nargs="?", default="./mccore/src/main/resources/assets", help="Directory path to start the replacement")#"./mccore/build/resources/main/assets"
    parser.add_argument("json_file_path", nargs="?", default="./transformers/json_univ_dictionary.json", help="JSON file path with replacement dictionary")

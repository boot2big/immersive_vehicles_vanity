...
public class MTSPackLoader{
	...
	public static final String MODID="acive";
	...
	public static final String DEPS="required-after:mts@[21.0.0,);";
	...
	System.out.println("IVV is only hosted at");
	System.out.println("https://www.planetminecraft.com/mod/immersive-vehicles-vanity-mts-iv-pack/");
	System.out.println("https://www.curseforge.com/minecraft/mc-mods/immersive-vehicles-vanity/");
	/*
		try{
